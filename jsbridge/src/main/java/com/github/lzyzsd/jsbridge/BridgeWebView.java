...
public class BridgeWebView extends WebView implements EcoJsBridge {

	private final String TAG = "BridgeWebView";
	private ProgressBar progressBar;

	public static final String initJs = "init.js";
	public static final String toLoadJs = "EcoJsBridge.js";
	Map<String, CallBackFunction> responseCallbacks = new HashMap<>();
	Map<String, BridgeHandler> messageHandlers = new HashMap<>();
	BridgeHandler defaultHandler = new DefaultHandler();
	BridgeWebViewClient webViewClient;
	...
	private class BridgeWebChromeClient extends WebChromeClient {
		@Override
